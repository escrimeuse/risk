...
Player::Player(std::string aName) : name(aName), ownedCountries(new list<Country*>), ownedContinents(new list<Continent*>), numOfOwnedCountries(0), numOfOwnedContinents(0), numCardsArtillery(0), numCardsCavalry(0), numCardsInfantry(0), playersArtilleryCards(new list<Card*>), playersCavalryCards(new list<Card*>), playersInfantryCards(new list<Card*>), playersWildCards(new list<Card*>) {

};

Player::Player(std::string aName, list<Country*> *countries, list<Continent*> *continents, int num, int art, int cav, int infan): name(aName), ownedCountries(countries), ownedContinents(continents), numCardsArtillery(art), numCardsCavalry(cav), numCardsInfantry(infan), playersArtilleryCards(new list<Card*>), playersCavalryCards(new list<Card*>), playersInfantryCards(new list<Card*>), playersWildCards(new list<Card*>) {
